...
if (isSelDoubleSin)
    fid_out   = fopen('./simDataCosOut.txt');
    fid_ideal = fopen('./simDataSinOut.txt');
    fid_in    = fopen('./simDataSinOut.txt');
else
    fid_out   = fopen('./simDataOut_N.txt');
    fid_ideal = fopen('./filtereddata_N.txt');
    fid_in    = fopen('./Int_noise.txt');
end
