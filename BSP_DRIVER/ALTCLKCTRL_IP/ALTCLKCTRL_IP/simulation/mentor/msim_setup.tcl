...
# ACDS 15.0 145 win32 2018.07.15.04:04:33
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "ALTCLKCTRL_IP"
}
...
alias com {
  echo "\[exec\] com"
  vlog "$QSYS_SIMDIR/submodules/ALTCLKCTRL_IP_altclkctrl_0.v" -work altclkctrl_0
  vlog "$QSYS_SIMDIR/ALTCLKCTRL_IP.v"                                           
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L altclkctrl_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L altclkctrl_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
