...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog "$QSYS_SIMDIR/submodules/ALTCLKCTRL_IP_altclkctrl_0.v" -work altclkctrl_0 -cdslib ./cds_libs/altclkctrl_0.cds.lib
  ncvlog "$QSYS_SIMDIR/ALTCLKCTRL_IP.v"                                                                                   
fi
