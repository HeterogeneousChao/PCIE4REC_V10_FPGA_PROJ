...
lappend arg_list "--report-file=csv:DDR2_SIP_DQ16BIT_IP_SLAVE_example.csv"
lappend arg_list "--report-file=qip:DDR2_SIP_DQ16BIT_IP_SLAVE_example.qip"
lappend arg_list "--output-name=DDR2_SIP_DQ16BIT_IP_SLAVE_example"
