...
lappend arg_list "--component-param=SEQ_ROM=DDR2_SIP_DQ16BIT_IP_SLAVE_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=DDR2_SIP_DQ16BIT_IP_SLAVE_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=DDR2_SIP_DQ16BIT_IP_SLAVE_s0_inst_ROM.hex"
...
lappend arg_list "--output-name=DDR2_SIP_DQ16BIT_IP_SLAVE_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=CYCLONEV"
lappend arg_list "--report-file=sopcinfo:DDR2_SIP_DQ16BIT_IP_SLAVE_s0.sopcinfo"
lappend arg_list "--report-file=txt:DDR2_SIP_DQ16BIT_IP_SLAVE_s0_seq_ipd_report.txt"
