// DDR2_SIP_DQ16BIT_IP_MASTER_0002.v
...
`timescale 1 ps / 1 ps
module DDR2_SIP_DQ16BIT_IP_MASTER_0002 (
	...
	DDR2_SIP_DQ16BIT_IP_MASTER_pll0 pll0 (
	...
	DDR2_SIP_DQ16BIT_IP_MASTER_p0 p0 (
		.global_reset_n              (global_reset_n),                             //        global_reset.reset_n
	...
	DDR2_SIP_DQ16BIT_IP_MASTER_s0 s0 (
		.avl_clk                     (p0_avl_clk_clk),                               //          avl_clk.clk
		.avl_reset_n                 (p0_avl_reset_reset),                           //        avl_reset.reset_n
		.scc_clk                     (p0_scc_clk_clk),                               //          scc_clk.clk
	...
	DDR2_SIP_DQ16BIT_IP_MASTER_dmaster #(
		.USE_PLI     (0),
		.PLI_PORT    (50000),
		.FIFO_DEPTHS (2)
	) dmaster (
	...
	DDR2_SIP_DQ16BIT_IP_MASTER_c0 c0 (
		.afi_reset_n         (afi_reset_n),                //    afi_reset.reset_n
		.afi_clk             (afi_clk),                    //      afi_clk.clk
		.afi_half_clk        (afi_half_clk),               // afi_half_clk.clk
	...
	DDR2_SIP_DQ16BIT_IP_MASTER_mm_interconnect_0 mm_interconnect_0 (
