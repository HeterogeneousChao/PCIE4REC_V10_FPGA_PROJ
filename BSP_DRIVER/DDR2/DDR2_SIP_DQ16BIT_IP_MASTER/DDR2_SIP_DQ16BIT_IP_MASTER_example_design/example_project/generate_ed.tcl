...
lappend arg_list "--report-file=csv:DDR2_SIP_DQ16BIT_IP_MASTER_example.csv"
lappend arg_list "--report-file=qip:DDR2_SIP_DQ16BIT_IP_MASTER_example.qip"
lappend arg_list "--output-name=DDR2_SIP_DQ16BIT_IP_MASTER_example"
...
lappend arg_list "--component-param=MEM_CLK_FREQ=200.0"
lappend arg_list "--component-param=MEM_CLK_FREQ_MAX=200.0"
...
lappend arg_list "--component-param=MEM_IF_DM_PINS_EN=false"
lappend arg_list "--component-param=MEM_IF_DQSN_EN=false"
...
lappend arg_list "--component-param=MEM_ROW_ADDR_WIDTH=13"
lappend arg_list "--component-param=MEM_RTT_NOM=Disabled"
lappend arg_list "--component-param=MEM_SRT=2x refresh rate"
lappend arg_list "--component-param=MEM_TCL=7"
lappend arg_list "--component-param=MEM_TFAW_NS=45.0"
...
lappend arg_list "--component-param=MEM_TWTR=3"
...
lappend arg_list "--component-param=TIMING_TDQSCK=350"
...
lappend arg_list "--component-param=TIMING_TDQSQ=200"
...
catch { eval [concat [list exec "E:/altera/15.0/quartus//sopc_builder/bin/ip-generate" --component-name=alt_mem_if_ddr2_tg_ed] $arg_list] } temp
puts $temp
