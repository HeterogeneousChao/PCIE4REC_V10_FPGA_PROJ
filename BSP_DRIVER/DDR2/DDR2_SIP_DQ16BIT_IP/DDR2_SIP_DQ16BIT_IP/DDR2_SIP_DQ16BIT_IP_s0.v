...
module DDR2_SIP_DQ16BIT_IP_s0 (
	...
	rw_manager_ddr2 #(
		...
		.HCX_COMPAT_MODE                      (0),
		.DEVICE_FAMILY                        ("CYCLONEV"),
		.AC_ROM_INIT_FILE_NAME                ("DDR2_SIP_DQ16BIT_IP_s0_AC_ROM.hex"),
		.INST_ROM_INIT_FILE_NAME              ("DDR2_SIP_DQ16BIT_IP_s0_inst_ROM.hex"),
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (22528),
		.INIT_FILE        ("DDR2_SIP_DQ16BIT_IP_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	DDR2_SIP_DQ16BIT_IP_s0_mm_interconnect_0 mm_interconnect_0 (
	...
	DDR2_SIP_DQ16BIT_IP_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk
