// DDR2_SIP_DQ16BIT_IP_example_d0.v
...
`timescale 1 ps / 1 ps
module DDR2_SIP_DQ16BIT_IP_example_d0 #(
		...
		parameter TG_POWER_OF_TWO_BURSTS_ONLY            = 1,
		parameter TG_BURST_ON_BURST_BOUNDARY             = 1,
		...
		parameter TG_TEMPLATE_STAGE_COUNT                = 0,
		parameter TG_SEQ_ADDR_GEN_MIN_BURSTCOUNT         = 2,
		parameter TG_SEQ_ADDR_GEN_MAX_BURSTCOUNT         = 2,
		parameter TG_RAND_ADDR_GEN_MIN_BURSTCOUNT        = 2,
		parameter TG_RAND_ADDR_GEN_MAX_BURSTCOUNT        = 2,
		parameter TG_RAND_SEQ_ADDR_GEN_MIN_BURSTCOUNT    = 2,
	...
	generate
		...
		if (TG_POWER_OF_TWO_BURSTS_ONLY != 1)
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
		...
		if (TG_BURST_ON_BURST_BOUNDARY != 1)
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
		...
		if (TG_SEQ_ADDR_GEN_MIN_BURSTCOUNT != 2)
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
		...
		if (TG_RAND_ADDR_GEN_MIN_BURSTCOUNT != 2)
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
		...
		if (TG_RAND_SEQ_ADDR_GEN_MIN_BURSTCOUNT != 2)
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
