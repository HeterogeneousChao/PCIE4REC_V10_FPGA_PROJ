...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_functions.sv"     -work RESET_CONTROLLER_IP
  vlogan +v2k -sverilog "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_resync.sv"           -work RESET_CONTROLLER_IP
  vlogan +v2k -sverilog "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_reset_control.sv" -work RESET_CONTROLLER_IP
  vlogan +v2k -sverilog "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_reset_counter.sv"    -work RESET_CONTROLLER_IP
  vlogan +v2k           "$QSYS_SIMDIR/RESET_CONTROLLER_IP.v"                                                           
fi
