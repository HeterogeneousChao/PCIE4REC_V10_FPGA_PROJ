...
# ACDS 15.0 145 win32 2017.12.06.05:18:19
...
alias com {
  echo "\[exec\] com"
  vlog       "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_functions.sv"     -work RESET_CONTROLLER_IP
  vlog       "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_resync.sv"           -work RESET_CONTROLLER_IP
  vlog       "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_reset_control.sv" -work RESET_CONTROLLER_IP
  vlog       "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_reset_counter.sv"    -work RESET_CONTROLLER_IP
  vlog -v2k5 "$QSYS_SIMDIR/RESET_CONTROLLER_IP.v"                                                           
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L RESET_CONTROLLER_IP -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L RESET_CONTROLLER_IP -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
